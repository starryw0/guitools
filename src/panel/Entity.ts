...
export class MeshEntry {
    constructor(readonly isModelMesh: Boolean, readonly mesh: Mesh) { }
}
...
export interface EffectGuiExportParams {
    bokehPassParams?: BokehPassParamters | null,//景深
    bloomPassParams?: BloomPassParams | null,//辉光
